...
MY_CONSUMER_KEY = '6AkpAPhwF4beFekyHsOI5sb1f' #Your Twitter API Consumer Key
MY_CONSUMER_SECRET = '7gVBkF5OQ5oOjJBhBGUeC2iBiUJ7sQbRyVykWdfs5sy0iLzGho' #Your Consumer Secret Key
MY_ACCESS_TOKEN_KEY = '1098655684151910405-dNnCap4lSuWrw10Ak9o0FWN8KepQiP' #Your Twitter API Access Token Key
MY_ACCESS_TOKEN_SECRET = 'wqkwdELu30AI2hZM2v2bz1hoZWRQMacElH8WyzH1WnAS4' #Your Access Token Secret
...
TWITTER_SOURCE_ACCOUNTS = ["hauntedlunchbox]  # A list of comma-separated, quote-enclosed Twitter handles of account that you'll generate tweets based on. It should look like ["account1", "account2"]. If you want just one account, no comma needed.
...
TWEET_ACCOUNT = "hauntedlunchbot"  # The name of the account you're tweeting to.
